...
/* add — returns the evicted (least recently active) entry when over capacity, else NULL.
 *        The victim is already removed from the hash table; caller must only destroy it. */
