 ...
 *        LRU_DEFINE_FIND   — pure lookup, no LRU bump (for batch hot paths)
...
/* Pure lookup — no LRU bump.  Use inside batch loops where a single         \
 * TOUCH at batch-end replaces N redundant DEL+ADD operations.               */
